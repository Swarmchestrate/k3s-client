...
class ApplicationManager:
    ...
    def apply_manifest(self, manifest_file, app_label=None, namespace=None):
        ...
        self.manifest_registry[key] = {"type": "manifest", "resource": manifest_file, "namespace": namespace}
        return output

    @handle_errors
    def create_configmap(self, name, namespace=None, from_literal=None, from_file=None, app_label=None):
        namespace = namespace or DEFAULT_NAMESPACE
        ...
        self.manifest_registry[key] = {"type": "configmap", "resource": name, "namespace": namespace}
        return output
    ...
    def delete_application(self, app_label=None, namespace=None):
        ...
        if key in self.manifest_registry:
            ...
            return self.pod_manager.destroy_pod(pod_label=label_selector, namespace=namespace)
